...
function myFunction() {
  ...
  var valuesToCopy = sheet.getRange(row, 1,1,sheet.getLastColumn()).getValues();
  Logger.log(valuesToCopy);
  sheet.getRange(sheet.getLastRow()+1,1,1,valuesToCopy[0].length).setValues(valuesToCopy);
}
